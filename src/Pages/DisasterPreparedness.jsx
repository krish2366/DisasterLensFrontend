...
const DisasterPreparedness = () => {
  ...
  return (
    <div className="p-6 min-w-5xl  bg-gray-600">
      {/* Hero Section */}
      ...
      {/* Disaster Types */}
      <div className="flex flex-col p-4 px-32 gap-10">
        <div className="flex flex-col md:flex-row items-center justify-between bg-blue-900 text-white p-6 rounded-lg shadow-lg">
          ...
          <div className="md:w-1/2 flex flex-col items-center gap-3">
            ...
            <a href="#flood" className="bg-blue-300 p-4 w-[20rem] text-center">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-between bg-blue-900 text-white p-6 rounded-lg shadow-lg">
          ...
          <div className="md:w-[40%] flex flex-col items-center gap-3">
            ...
            <a href="#earthquake" className="bg-blue-300 p-4 w-[22rem] text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between bg-blue-900 text-white p-6 rounded-lg shadow-lg">
          ...
          <div className="md:w-1/2 flex flex-col items-center gap-3">
            ...
            <a href="#cyclone" className="bg-blue-300 p-4 w-[20rem] text-center">
      ...
      >
        <h1 className="text-4xl text-center font-bold">
          🌊 Flood Preparedness and Response Guide
        </h1>

        <div className="p-6 grid grid-cols-2 gap-5">
          <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
            <h3 className="text-3xl ml-3 font-semibold">
              Early Warning Signs of a Flood
            </h3>
            <p className="text-xl ml-3 mt-3">
              Floods can occur suddenly, but some warning signs can help you
              prepare:
            </p>
            <ul className="ml-6 mt-2 text-lg list-disc list-inside ">
              <li> Heavy Rainfall lasting for extended periods.</li>
              <li>
                {" "}
                Rapidly Rising Water Levels in rivers, lakes, or streams.
              </li>
              ...
              <li>
                {" "}
                Difficulty in Vehicle Movement due to water accumulation.
              </li>
          ...
          <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
            ...
            <p className="text-xl mt-3">
              Preparation can reduce damage and save lives:
            </p>

            <h4 className="text-2xl font-semibold">Protect Your Home</h4>
            <ul className="ml-6 mt-2 text-lg list-disc list-inside">
              <li>
                Elevate Electrical Equipment – Move appliances and wiring to
                higher floors.
              </li>
              <li>
                Seal Walls & Gaps – Use waterproof materials to prevent water
                from seeping in.
              </li>
              <li>Stock Sandbags – Helps divert water away from your home.</li>
              <li>
                Keep Emergency Kit Ready – Include food, water, first-aid,
                flashlight, and batteries.
              </li>
              <li>Know Evacuation Routes – Plan safe exits in advance.</li>
            </ul>

            <h4 className="text-2xl font-semibold">Personal Safety Measures</h4>
            <ul className="ml-6 mt-2 text-lg list-disc list-inside">
              <li>Store Clean Water – Floods can contaminate supply.</li>
              <li>Prepare Emergency Contacts – Inform family and neighbors.</li>
              <li>
                Backup Important Documents – Keep digital and physical copies.
              </li>
          ...
          <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
            ...
            <ul className="ml-6 mt-2 text-lg list-disc list-inside">
              <li>
                Avoid Walking or Driving Through Floodwater – Just 6 inches of
                moving water can knock you down.
              </li>
              <li>
                Seek Higher Ground Immediately – Move to a sturdy shelter.
              </li>
              <li>
                Listen to Emergency Alerts – Follow official instructions.
              </li>
            </ul>

            <h4 className="text-2xl font-semibold">If You're Indoors</h4>
            <ul className="ml-6 mt-2 text-lg list-disc list-inside">
              <li>
                Turn Off Electricity and Gas – Prevent short circuits or
                explosions.
              </li>
              <li>
                Stay in Upper Floors – Avoid basements and low-lying areas.
              </li>
              <li>
                Call for Help If Needed – Use mobile networks or emergency
                numbers.
              </li>
          ...
          <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
            <h3 className="text-3xl font-semibold">
              After the Flood: Recovery & Safety Measures
            </h3>

            <h4 className="text-2xl font-semibold">Returning Home</h4>
            <ul className="ml-6 mt-2 text-lg list-disc list-inside">
              <li>
                Inspect Your Home Before Entering – Check for structural damage.
              </li>
              <li>
                Do Not Turn On Electricity Immediately – Have a professional
                inspect the system first.
              </li>
              <li>
                Wear Protective Gear – Floodwater can contain harmful bacteria.
              </li>
              <li>
                Boil Drinking Water – Contaminated water can cause diseases.
              </li>
            </ul>

            <h4 className="text-2xl font-semibold">Cleaning & Repairing</h4>
            <ul className="ml-6 mt-2 text-lg list-disc list-inside">
              <li>
                Avoid Contact with Standing Water – It might be electrically
                charged or contaminated.
              </li>
              <li>Disinfect Surfaces – Use bleach and cleaning solutions.</li>
              <li>
                Document Damage for Insurance Claims – Take photos of affected
                areas.
              </li>
            </ul>
          </div>
      ...
      <div id="earthquake" className="bg-gray-900  p-10 m-10 rounded-lg shadow-lg">
        ...
        <div className="p-6 grid grid-cols-2 gap-5">
            <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
                <h3 className="text-3xl ml-3 mt-3 font-semibold">
                Early Warning Signs of an Earthquake
                </h3>
                <p className="text-xl ml-3 mt-3">
                Although earthquakes strike suddenly, some precursors may indicate
                seismic activity:
                </p>
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                <li>
                    <strong>Foreshocks</strong> – Small tremors before the main
                    earthquake.
                </li>
                <li>
                    <strong>Animal Behavior</strong> – Some animals behave erratically
                    before a quake.
                </li>
                <li>
                    <strong>Unusual Ground Vibrations</strong> – You may feel subtle
                    shaking.
                </li>
                <li>
                    <strong>Government Warnings</strong> – Alerts based on detected
                    tremors.
                </li>
                <li>
                    <strong>Deep Rumbles</strong> – A low, distant roaring sound might
                    precede shaking.
                </li>
                </ul>
            </div>
            ...
            <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
                <h3 className="text-3xl ml-3 font-semibold mt-6">
                Before the Earthquake: How to Prepare
                </h3>
                <p className="text-xl ml-3 mt-3">
                Taking precautions beforehand can reduce damage and save lives.
                </p>

                <h4 className="text-2xl ml-3 font-semibold">
                Protect Your Home & Workplace
                </h4>
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                <li>
                    Secure heavy items – Bolt down shelves, mirrors, and furniture.
                </li>
                <li>
                    Reinforce buildings – Ensure earthquake-resistant construction.
                </li>
                <li>
                    Prepare an emergency kit – Include food, water, and first aid.
                </li>
                <li>Know safe spots – Identify sturdy places like under tables.</li>
                <li>Plan evacuation routes – Have multiple exit strategies.</li>
                </ul>

                <h4 className="text-2xl ml-3 font-semibold mt-4">
                Personal Safety Measures
                </h4>
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                <li>
                    Practice earthquake drills – Teach family and coworkers how to
                    respond.
                </li>
                <li>Store emergency contacts – Keep a list of important numbers.</li>
                <li>
                    Keep shoes & flashlight near your bed – Protect yourself from broken
                    glass.
                </li>
            ...
            <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
                ...
                <h4 className="text-2xl ml-3 font-semibold">If You're Indoors</h4>
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                <li>
                    <strong>Drop, Cover, and Hold On</strong> – Take cover under a
                    sturdy table.
                </li>
                <li>
                    <strong>Stay Away from Windows & Walls</strong> – Glass and debris
                    can shatter.
                </li>
                <li>
                    <strong>Do Not Use Elevators</strong> – They can get stuck.
                </li>
                <li>
                    <strong>Stay Indoors Until Shaking Stops</strong> – Going outside is
                    dangerous.
                </li>
                </ul>

                <h4 className="text-2xl ml-3 font-semibold mt-4">If You're Outdoors</h4>
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                <li> Move away from buildings, trees, and power lines.</li>
                <li> Lie flat in hilly areas – Landslides can occur.</li>
                <li>
                    If driving, stop safely – Avoid stopping under bridges or tunnels.
                </li>
                </ul>
            </div>
            ...
            <div className="bg-blue-300 rounded-xl p-5 flex flex-col items-center justify-center">
                <h3 className="text-3xl ml-3 font-semibold mt-6">
                After the Earthquake: Recovery & Safety Measures
                </h3>

                <h4 className="text-2xl ml-3 font-semibold">Returning to Buildings</h4>
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                ...
                <li>
                    Seek medical help if injured – Even minor cuts can lead to
                    infections.
                </li>
                <li>
                    Listen to emergency broadcasts – Stay updated on safety measures.
                </li>
                </ul>
            </div>

        </div>
            <div className="bg-blue-300 rounded-xl p-5 m-6 mt-0 flex flex-col items-center justify-center">
                <h3 className="text-3xl ml-3 font-semibold mt-6">
                ...
                <ul className="ml-6 mt-2 text-lg list-disc list-inside">
                <li>
                    "Doorways are the safest places" – Only true for old buildings.
                </li>
                <li>
                    "Earthquakes happen only in certain areas" – They can occur
                    anywhere.
                </li>
                <li>
                    "You can predict an earthquake" – No reliable prediction system
                    exists yet.
                </li>
                </ul>
            </div>
      ...
      <div className="mt-10 text-center">
        <a
          ...
          download
          className="bg-gray-800 text-white px-6 py-3 rounded-lg shadow-md text-lg font-semibold"
        >
